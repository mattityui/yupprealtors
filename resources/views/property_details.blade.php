            ...
            <div class="col-lg-6">
                <form>
                    <div class="property_details">
                        <h1><strong>{{ $propertyDetails->address }}</strong></h1> <br>
                        <div class="details">
                            <div class="price-wrapper">
                                <p class="price-text"><strong>₱{{ number_format($propertyDetails->price)
                                        }}</strong><br>Price</p>
                            </div>
                            <h1>|</h1>
                            <div class="bedrooms-wrapper">
                                <p class="bedrooms-text"><strong>{{ $propertyDetails->room }}</strong><br>Beds </p>
                            </div>
                            <h1>|</h1>
                            <div class="bathrooms-wrapper">
                                <p class="bathrooms-text"><strong>{{ $propertyDetails->tb }}</strong><br>Baths</p>
                            </div>
                            <h1>|</h1>
                            <div class="floor-wrapper">
                                <p class="floor-text"><strong>{{ number_format($propertyDetails->floor_area)
                                        }} sqft</strong><br>Floor Area</p>
                            </div>
                            <h1>|</h1>
                            <div class="lot-wrapper">
                                <p class="lot-text"><strong>{{ number_format($propertyDetails->lot_area)
                    ...
                    <div class="tour">
                        <a href="{!! route('scheduled.tour.form', ['propertyId' => $propertyDetails->id, 'propertyImageId' => $firstPropertyImage->id]) !!}"
