...
<head>
    ...
    <title>{{ $propertyCondoDetails->address }}</title>
            ...
            <div class="col-lg-6">
                <form>
                    <div class="property_details">
                        <h1><strong>{{ $propertyCondoDetails->condo_address }}</strong></h1> <br>
                        <div class="details">
                            <div class="price-wrapper">
                                <p class="price-text"><strong>₱{{ number_format($propertyCondoDetails->condo_price)
                                        }}</strong><br>Price</p>
                            </div>
                            <h1>|</h1>

                            <div class="floor-wrapper">
                                <p class="floor-text"><strong>{{ number_format($propertyCondoDetails->condo_floor_area)
                    ...
                    <div class="tour">
                        <a href="{!! route('scheduledcondo.tour.form', ['propertyId' => $propertyCondoDetails->condo_id, 'propertyImageId' => $firstPropertyCondoImage->id]) !!}"
